<%@ Page Title="" Language="C#" validateRequest="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AustralianMade.aspx.cs" Inherits="Ruestonwater.Admin.AustralianMade" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <h2>Australian Made Page<asp:Button ID="preview" runat="server" Text="Preview" CssClass="btnleft" OnClick="preview_Click" /></h2>
        <hr />
        <h3>Section 1</h3>
        <div>
            ...
            <asp:TextBox ID="tbp1title" runat="server" Width="400px" Height="30px" placeholder="Main Title"></asp:TextBox><br />
            <asp:TextBox ID="tbp1title1" runat="server" Width="400px" Height="30px" placeholder="Sub Title"></asp:TextBox><br />
            <br />
        ...
        <div>
            ...
            <asp:TextBox ID="tbp2title" runat="server" Width="400px" Height="30px" placeholder="Main Title"></asp:TextBox><br />
            <asp:TextBox ID="tbp2title1" runat="server" Width="400px" Height="30px" placeholder="Sub Title"></asp:TextBox><br /><br />
        ...
        <div>
            ...
            <asp:TextBox ID="tbp3title" runat="server" Width="400px" Height="30px" placeholder="Main Title"></asp:TextBox><br />
            <asp:TextBox ID="tbp3title1" runat="server" Width="400px" Height="30px" placeholder="Sub Title"></asp:TextBox><br /><br />
        ...
        <div>
            ...
            <asp:TextBox ID="tbp4title" runat="server" Width="400px" Height="30px" placeholder="Main Title"></asp:TextBox><br />
            <asp:TextBox ID="tbp4title1" runat="server" Width="400px" Height="30px" placeholder="Sub Title"></asp:TextBox><br /><br />
