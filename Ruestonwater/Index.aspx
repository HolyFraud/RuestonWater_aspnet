...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Home - Rueston Water - Botanical Power Water From Vegetables and Fruits</title>
    <meta http-equiv="X-UA-compatible" content="IE=edge"/>    <meta content="yes" name="apple-mobile-web-app-capable" />
    <meta content="black-translucent" name="apple-mobile-web-app-status-bar-style" />
    <meta content="telephone=no" name="format-detection" />
    <meta content="email=no" name="format-detection" />
    <meta name="viewport" content="width=device-width, initial-scale=0.7">
    <meta content="Home, Australian Rueston Water, 100% from fruit & vegetables, Grow Water From Earth to Bottle, Full Bodied Water, Natural Cycle" name="keywords"/>
